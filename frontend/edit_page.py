...
class EditPage(Main):
    def __init__(self, root):
        ...
        self.win_title = "Edit Information"
        ...
        info_label = Label(body_container, text="Edit Information Here", bg=self.white, font=(self.header_font, self.header_size, self.normal))
        ...
        img_name.place(x=310, y=140, width=400, height=30)
    ...
    def save_activity(self):
        ...
        elif title not in posts_record:
            messagebox.showerror("Error", "Post does not exists")

        else:
            insert_query = "update posts set information=%s,image=%s,username=%s where title=%s "
